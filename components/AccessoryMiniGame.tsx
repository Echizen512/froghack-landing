...
const frogs = [
  {
    ...
    accessories: [
      { name: 'Ghost Protocol', image: '/Ghost_Protocol.png', top: '-10%', left: '70%' },
      { name: 'Darkrypt', image: '/Darkrypt.png', top: '10%', left: '-15%' },
      { name: 'Voltrush', image: '/Voltrush.png', top: '60%', left: '-15%' },
      { name: 'Frogne', image: '/Frogne.png', top: '70%', left: '85%' },
      { name: 'FireJacket', image: '/FireJacket.png', top: '30%', left: '80%' },
    ],
  },
  {
    name: 'FrogTwo',
    ...
    accessories: [
      { name: 'Darksight', image: '/Darksight.png', top: '-10%', left: '70%' },
      { name: 'Jammer', image: '/Jammer.png', top: '10%', left: '-18%' },
      { name: 'Voidstep', image: '/Voidstep.png', top: '55%', left: '-18%' },
      { name: 'Nullpack', image: '/Nullpack.png', top: '70%', left: '85%' },
      { name: 'Shadowsuit', image: '/Shadowsuit.png', top: '30%', left: '80%' },
    ],
  },
  {
    name: 'FrogThree',
    ...
    accessories: [
      { name: 'Bluewave', image: '/Bluewave.png', top: '-10%', left: '70%' },
      { name: 'Blackout', image: '/Blackout.png', top: '-10%', left: '-10%' },
      { name: 'Voidstep', image: '/Voidsteps2.png', top: '55%', left: '-15%' },
      { name: 'Netfroak', image: '/Netfroak.png', top: '70%', left: '85%' },
      { name: 'Spysuit', image: '/Spysuit.png', top: '28%', left: '80%' },
      { name: 'Noctyra', image: '/Noctyra.png', top: '20%', left: '-20%' },
    ],
  },
];

export const AccessoryMiniGame = () => {
        ...
        {frogs.map((frog, index) => (
          <SwiperSlide key={frog.name}>
            <div className='flex flex-col items-center'>
              ...
              >
                {equippedStates[index] ? 'Unequip Accessories' : 'Equip Accessories'}
              </button>
